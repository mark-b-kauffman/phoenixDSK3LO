...
defmodule PhoenixDSK3LO do
  ...
  def start(_type, _args) do
    ...
    children = [
      ...
      supervisor(PhoenixDSK3LO.Endpoint, []),
      # Start your own worker by calling: PhoenixDSK3LO.Worker.start_link(arg1, arg2, arg3)
      # worker(PhoenixDSK3LO.Worker, [arg1, arg2, arg3]),
    ...
    opts = [strategy: :one_for_one, name: PhoenixDSK3LO.Supervisor]
  ...
  def config_change(changed, _new, removed) do
    PhoenixDSK3LO.Endpoint.config_change(changed, removed)
    :ok
  end
end
